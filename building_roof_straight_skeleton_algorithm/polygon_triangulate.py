...
#    Cambridge, 1998,
#    ISBN: 0521649765  [Titel anhand dieser ISBN in Citavi-Projekt ?bernehmen] ,
#    LC: QA448.D38.
#
#  Parameters:
#
...
#    Computational Geometry in C,
#    Cambridge, 1998,
#    ISBN: 0521649765 %CITAVIPICKER?0521649765?Titel anhand dieser ISBN in Citavi-Projekt ?bernehmen?%,
#    LC: QA448.D38.
#
#  Parameters:
#
...
##n = 5
##x = np.array ( [ 5.09,  1.68,  1.48,  5.89,  7.86 ] )
##y = np.array ( [ 5.80,  4.90,  1.38, -0.63,  4.29 ] )

###concave Polygon:
##n = 5
##x = np.array ( [ 5.09,  1.68,  1.48,  5.89,  4.50 ] )
##y = np.array ( [ 5.80,  4.90,  1.38, -0.63,  2.90 ] )

###Hauspolygon
##n = 9
##x = np.array ( [ 3.15,  3.09,  1.44,  1.47,  2.08,  4.64,  4.64,  6.43,  6.47 ] )
##y = np.array ( [ 5.90,  4.55,  4.56,  2.44,  0.88,  0.86,  1.98,  1.93,  5.90 ] )
##
##triangles = polygon_triangulate ( n, x, y )
##
##i4mat_print ( n - 2, 3, triangles, '  Triangles' )
